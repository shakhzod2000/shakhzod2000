...
I am a Backend Developer with a passion for building clean, reliable, and scalable backend systems. I started my career as a student in a coding school namely [42 Berlin](https://42berlin.de/). I have professional experience in Python(Django), Java, PHP, PostgreSQL, MySQL, JavaScript, C Docker, Nginx, Celery, Redis, AWS and modern API design. Here's my first independently organized project [essential-words.uz](https://essential-words.uz), you can check the repository [here](https://github.com/shakhzod2000/essential-words-old).
## Skills
<p align="left">
